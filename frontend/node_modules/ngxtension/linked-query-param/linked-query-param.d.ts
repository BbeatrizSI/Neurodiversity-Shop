import { Injector, Provider, WritableSignal } from '@angular/core';
 ...
 */
type NavigateMethodFields = Pick<NavigationExtras, 'queryParamsHandling' | 'onSameUrlNavigation' | 'replaceUrl' | 'skipLocationChange' | 'preserveFragment'>;
export declare function provideLinkedQueryParamConfig(config: Partial<NavigateMethodFields>): Provider;
/**
